...
CREATE TABLE ATTENDANCE (
    ...
    qr_code_id BIGINT,
    member_id BIGINT NOT NULL,
    attendance_status VARCHAR(20) NOT NULL CHECK (attendance_status IN ('PRESENT', 'LATE', 'ABSENT', 'EXCUSED')),
    ...
    FOREIGN KEY (session_id) REFERENCES SESSION(id),
    FOREIGN KEY (member_id) REFERENCES MEMBER(id),
    CONSTRAINT UK_ATTENDANCE_SESSION_COHORT_MEMBER UNIQUE (session_id, member_id)
);
